...
@interface ShapeFilter_VC ()<FilterBarDelegate>
...
- (void)setupFilterBar {
    ...
    NSArray *dataSource = @[@"无",@"缩放",@"灵魂出窍",@"抖动",@"闪白",@"毛刺"];
...
- (void)filterBar:(FilterBar *)filterBar didScrollToIndex:(NSUInteger)index {
    ...
    if (index == 0) {
        ...
        [self setupFlashLightShaderProgram];
    }else if (index == 5) {
...
// 闪白滤镜着色器程序
- (void)setupFlashLightShaderProgram {
    //设置着色器程序
    [self setupShaderProgramWithName:@"FlashLight"];
}
